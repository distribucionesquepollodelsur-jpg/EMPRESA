...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
    ...
    const menuItems = [
        ...
        { id: 'financial-statements', label: 'Estados Financieros', icon: FileCheck, adminOnly: true },
        ...
        { id: 'vehicle-installments', label: 'Abonos Vehículo', icon: CreditCard, adminOnly: true },
